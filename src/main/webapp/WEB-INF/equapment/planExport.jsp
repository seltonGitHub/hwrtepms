...
<script type="text/javascript" >
  ...
  function Remove() {
   ...
   function setValue(){
     ...
     function checksubmit(){
       ...
       document.Form1.action="/device/savePlanModel.html";
  ...
  <body onload="setValue()">
   <FORM id=Form1 name=Form1  method=POST  action="/device/savePlanModel.html">
   <br>
           ...
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                  ...
                  <select size="15" name="colname1" multiple style="width:200px" id="colname1" ondblclick="JavaScript:Add('colname1','colname2','colname')">
                      <c:forEach items="${noinitfields}" var="fd">
                          <option value="${fd.dbName}" >${fd.excelName}</option>
                      </c:forEach>
                   ...
                   <select size="15" name="colname2" id="colname2" multiple style="width:200px" ondblclick="JavaScript:Remove('colname1','colname2','colname')">
                     <c:forEach items="${initfields}" var="fd">
                         <option value="${fd.dbName}" >${fd.excelName}</option>
                     </c:forEach>
