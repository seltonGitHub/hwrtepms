...
<form name="importForm" method="post" action="/device/uploadPlanExcel.html" enctype="multipart/form-data">
      <br>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
              <td colspan="10">
                  请务必先： <a href="/device/downloadPlanExcelModel.html">下载导入文件模板</a>
              </td>
          </tr>
		<tr>
        ...
        <tr>
          ...
          <td width="83%" align="left"><input type="file" name="file"  accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"  value="" style="width:365px"></td>
          <td width="1%"></td>
        </tr>
    ...
    <div style="color:#f00; font-weight: bold;">${result}</div>
