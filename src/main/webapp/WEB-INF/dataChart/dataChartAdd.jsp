...
<script language="javascript">
	 function init(){
	   document.getElementById("BT_Submit").disabled=true;
		...
		function addFileList(){
			...
			var tbl=document.getElementById("filesTbl");
		      for (i=1;i<tbl.rows.length;i++){
		   	  ...
		   	  {		   	  
						document.Form1.action = "/dataChart/doUpload.html";
		...
		function changeList() {
			...
			var str = '/dataChart/showUploadFiles.html?projId='+projId+'&belongTo='+belongTo;
	...
	<body onload="init();">
		<br>
		    <form id="Form1" name="Form1" action="/dataChart/doUpload.html" method="post" enctype="multipart/form-data">
									...
									<td class="ta_01">
										...
										<select name="projId" id="projId" style="width:160px" onchange="changeList();">
											...
											<c:forEach items="${allProjIDs}" var="projid">
												<option value="${projid.ddlcode}-${projid.ddlname}">${projid.ddlname}</option>
											</c:forEach>
										</select>
										...
										<font face="宋体" color="red"> 
											...
											<select name="belongTo" id="belongTo" style="width:160px" onchange="changeList();">
												...
												<c:forEach items="${allBelongTos}" var="belongTo">
													<option value="${belongTo.ddlcode}-${belongTo.ddlname}">${belongTo.ddlname}</option>
												</c:forEach>
											</select>
