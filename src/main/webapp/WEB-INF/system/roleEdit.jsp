				 ...
				 <td class="ta_01" colspan=2 align="left" width="100%" > 
				 	...
				 	<br>
				         ...
				         <table cellspacing="0" align="center" width="100%" cellpadding="1" rules="all" bordercolor="gray" border="1" 
							 ...
							 <c:forEach items="${rolePopedoms}" var="popedomItem" varStatus="vs">
							 <c:if test='${popedomItem.pid=="0"}'>
							 ...
							 <tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
								 <td class="ta_01"  align="left" width="18%" height="22" background="../images/tablehead.jpg" >
									 <input type="checkbox"  name="selectoper" id="${popedomItem.mid}_${popedomItem.mid}" value="${popedomItem.mid}" onClick='goSelect(this.id)'
									 <c:if test="${popedomItem.isChecked}">
											checked
									 </c:if>
									 	>
										 ${popedomItem.name}</td>
								 <td class="ta_01"  align="left" width="82%" height="22">
									 ...
									 <c:if test='${popedomItem.pid!="0"}'>
									 <div>
										 <input type="checkbox"  name="selectoper" id="${popedomItem.pid}_${popedomItem.mid}" value="${popedomItem.mid}" onClick='goSelect(this.id)'
				...
				<c:forEach items="${roleUsers}" var="roleUser">
					<tr onmouseover="this.style.backgroundColor = 'white'"
						...
						<td style="HEIGHT: 22px" class="ta_01" align="center" width="20%">
							<input type="checkbox" name="selectuser" value="${roleUser.userid}"
								<c:if test="${roleUser.checked}">
								   checked
							   </c:if>
							>
						</td>
