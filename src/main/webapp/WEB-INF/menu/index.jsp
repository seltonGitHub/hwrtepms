...
<head>
    ...
    <SCRIPT type="text/javascript">
        ...
        function check() {
            ...
            if (Trim(theForm.userpassword.value) == "") {
                alert("请输入用户密码");
...
<body onload="ini()">
<form action="/userCenter/loginUser.html" method="post" target="_top">
    <table border="0" width="100%" id="table1" height="532" cellspacing="0" cellpadding="0">
        <tr>
            <td><span style="color: red">${errorInfo}</span>　</td>
        </tr>
        <tr>
            <td height="467">
                        ...
                        <td align=center background="${pageContext.request.contextPath}/images/index.jpg">
                            <table border="0" width="98%" id="table3" height="412" cellspacing="0" cellpadding="0">
                                        ...
                                        <table border="0" width="70%" id="table4">
                                            <tr>
                                                <td width="100"><img border="0"
                                                                     src="${pageContext.request.contextPath}/images/yonghu.jpg"
                                                                     width="75" height="20"></td>
                                                <td><input type="text" name="username" style="width: 125 px" size="20"
                                                           value="" maxlength="25"></td>

                                            </tr>
                                            <tr>
                                                <td width="100"><img border="0"
                                                                     src="${pageContext.request.contextPath}/images/mima.jpg"
                                                                     width="75" height="20"></td>
                                                <td><input type="password" name="userpassword" style="width: 125 px"
                                                           size="20" value="" maxlength="25"></td>
								...
								-->
                                            <tr>
                                                <td width="100"></td>
                                                <td width="100"><input type="button" class=btn_mouseout
                                                                       onmouseover="this.className='btn_mouseover'"
                                                                       onmouseout="this.className='btn_mouseout'"
                                                                       value="登   录" name="huifubtn"
                                                                       onclick="checkFunction()"></td>
